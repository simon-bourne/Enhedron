...
static Test::Suite
    u("Util",
      ...
      given(
          "taggedValue",
          [](Check& check) {
              TaggedValue<SimpleEnum, SimpleEnum::VALUE_0, string> value(
                  helloWorld);
      ...
      exhaustive(escapedPairs, choice("", "prefix"), choice("", "postfix"))
          .given(
              "a prefix, a postfix and a char that requires escaping",
              [](Check& check,
                 pair<char, char> c,
                 const string& prefix,
