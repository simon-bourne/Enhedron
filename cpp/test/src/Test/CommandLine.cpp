...
void testEmpty(
    ...
    auto exitStatusCheck = Arguments(out(helpOut), out(errorOut), "")
                               .run(
    ...
    s("CommandLine",
      ...
      given(
          ...
          [](Check& check) {
              ...
              auto exitStatus = args.run(2, argv, [&](vector<string>) {
      ...
      given(
          ...
          [](Check& check) {
              const char* argv[] = {
                  "exeName", "--string2", "abc", "--string", "xyz"};
              ostringstream helpOut;
              ostringstream errorOut;

              auto exitStatus =
                  Arguments(out(helpOut), out(errorOut), "")
                      .run(
                          5,
                          argv,
                          [&](const string& arg,
      ...
      given(
          ...
          [](Check& check) {
              ...
              auto exitStatus =
                  Arguments(out(helpOut), out(errorOut), "", 40)
                      .run(
                          2,
                          argv,
                          ...
                          Option<string>(
                              Name("string1", "String 1 description"),
                              "string1Value"),
                          Option<string>(
                              Name(
                                  's',
                                  "string2",
                                  "String2descriptionShouldBeHyphenated"),
                              "string2Value"));
      ...
      given("VectorArgs", [](Check& check) {
          const char* argv[] = {
              "exeName", "--vector", "value0", "--vector", "value1"};
          ostringstream helpOut;
          ostringstream errorOut;
