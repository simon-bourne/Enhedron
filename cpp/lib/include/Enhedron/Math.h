...
namespace Enhedron { namespace Impl_Math {
    ...
    constexpr NumeratorType divideRoundingUp(NumeratorType numerator, DenominatorType denominator) {
        ...
        static_assert(numeric_limits<NumeratorType>::is_integer, "NumeratorType must be integer");
        static_assert(numeric_limits<DenominatorType>::is_integer, "DenominatorType must be integer");
    ...
    constexpr Value makeDivisibleByRoundingDown(Value value, Modulus modulus) {
        ...
        static_assert(numeric_limits<Modulus>::is_integer, "Modulus must be integer");
...
namespace Enhedron { namespace Math {
